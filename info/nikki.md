...
- 来源：[nikkinikki-org/OpenWrt-nikki](https://github.com/nikkinikki-org/OpenWrt-nikki)
- 包含软件包：`mihomo-meta`、`nikki`、`luci-app-nikki`
- 支持架构：`x86_64`、`aarch64_generic`、`aarch64_cortex-a53`
- 运行要求：OpenWrt 或 ImmortalWrt `24.10+`、`firewall4`、Linux 内核 `5.13+`

## 功能

- **代理工具**：基于 mihomo 核心的代理工具
- **规则路由**：支持智能规则路由和分流
...
```bash
# x86_64 设备
scp luci-app-nikki-*_x86_64.run root@192.168.1.1:/tmp/

# aarch64 设备
scp luci-app-nikki-*_aarch64_generic.run root@192.168.1.1:/tmp/
```
...
- 项目主页：https://github.com/nikkinikki-org/OpenWrt-nikki
